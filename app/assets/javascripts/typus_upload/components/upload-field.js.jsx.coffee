Typus.UploadField = createReactClass
  ...
  render: ->
    ...
    `<div className="form-group">
      <label className="control-label">{this.props.field_label}</label>
  ...
  renderItem: ->
    ...
    `<li className="list-group-item">
      <a href="#" className="close" onClick={this.onRemove}>&times;</a>
      <span className="glyphicon glyphicon-file"></span> {filename}
      <input type="hidden" name={this.props.field_name} value={field_value} />
    </li>`

  renderAddButton: ->
    `<li className="list-group-item">
      <a href="#" className="btn btn-default" onClick={this.onClickAdd}>Add attachments +</a>
      <input type="file" className="hidden" ref="input" onChange={this.onFileSelected} />
      <input type="hidden" name={this.props.field_name} value="" />
    </li>`
